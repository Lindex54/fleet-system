...
<main class="min-h-screen lg:pl-64">
                            ...
                            >
                                ...
                                <td class="border border-fleet-line px-4 py-4">
                                    <div class="flex justify-end gap-4">
                                        ...
                                        <form action="<?= htmlspecialchars($preInspectionFormAction, ENT_QUOTES, 'UTF-8'); ?>" method="post">
    ...
    >
        <div class="dashboard-scroll max-h-[calc(100vh-2.5rem)] w-full max-w-[900px] overflow-y-auto rounded-lg border border-fleet-line bg-fleet-surface shadow-2xl" role="dialog" aria-modal="true" aria-labelledby="pre-inspection-modal-title">
            ...
            <form class="p-6" action="<?= htmlspecialchars($preInspectionFormAction, ENT_QUOTES, 'UTF-8'); ?>" method="post" data-pre-inspection-form>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <label class="block">
                        ...
                        <select name="vehicle" required class="vehicle-form-control">
                            ...
                            <?php foreach ($preInspectionVehicleOptions as $vehicleOption): ?>
                                <option value="<?= htmlspecialchars((string) $vehicleOption['id'], ENT_QUOTES, 'UTF-8'); ?>" <?= (($preInspectionFormData['vehicle'] ?? '') === (string) $vehicleOption['id']) ? 'selected' : ''; ?>>
                    ...
                    <label class="block">
                        ...
                        <input name="mileage" type="number" min="0" class="vehicle-form-control" placeholder="e.g. 45230" value="<?= htmlspecialchars($preInspectionFormData['mileage'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                    </label>
                    <label class="block">
                ...
                <div class="mt-6 flex justify-end gap-3">
                    ...
                    <button type="submit" data-pre-inspection-submit-button class="h-10 rounded-lg bg-fleet-sidebar px-4 text-sm font-semibold text-white shadow-sm hover:bg-fleet-sidebar-active"><?= $preInspectionFormMode === 'update' ? 'Save Changes' : 'Save Report'; ?></button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="logbook-delete-card" role="dialog" aria-modal="true" aria-labelledby="pre-inspection-delete-modal-title">
            ...
            <div class="logbook-delete-body">
                ...
                <p class="logbook-delete-copy">
                    This pre-inspection report will be removed from the official records. This action cannot be undone.
                </p>
