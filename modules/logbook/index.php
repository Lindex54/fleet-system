...
<main class="min-h-screen lg:pl-64">
    ...
    <div id="logbook-modal" class="fixed inset-0 z-50 hidden items-start justify-center overflow-y-auto bg-black/75 px-4 py-5 sm:items-center" aria-hidden="true">
            ...
            <form class="p-5" action="#" method="post">
                ...
                <div class="grid gap-3 md:grid-cols-3">
                    <label class="block">
                        ...
                        <input name="date" type="date" required class="vehicle-form-control" value="2026-05-24" autofocus>
                    </label>
                    ...
                    <label class="block">
                        ...
                        <select name="driver" required class="vehicle-form-control">
                            <option value="">Select driver</option>
                            <option value="SIMALI HABERT">SIMALI HABERT</option>
                ...
                <div class="grid gap-3 md:grid-cols-2">
                    <label class="block">
                        ...
                        <input name="departure_location" type="text" required class="vehicle-form-control" placeholder="e.g. Main Campus, Tororo">
                    </label>

                    <label class="block">
                        <span class="mb-2 block text-sm font-semibold text-fleet-ink">Destination *</span>
                        <input name="destination" type="text" required class="vehicle-form-control" placeholder="e.g. Kampala">
                    </label>

                    <label class="block md:col-span-2">
                        <span class="mb-2 block text-sm font-semibold text-fleet-ink">Purpose of Journey *</span>
                        <textarea name="purpose" required class="vehicle-form-control min-h-14 resize-y py-3" placeholder="Describe the purpose of this trip"></textarea>
                    </label>
                </div>
                ...
                <div class="grid gap-3 md:grid-cols-4">
                    <label class="block">
                        ...
                        <input name="odometer_start" type="number" min="0" class="vehicle-form-control">
                    </label>

                    <label class="block">
                        <span class="mb-2 block text-sm font-semibold text-fleet-ink">Odometer End (km)</span>
                        <input name="odometer_end" type="number" min="0" class="vehicle-form-control">
                    </label>

                    <label class="block">
                        <span class="mb-2 block text-sm font-semibold text-fleet-ink">Fuel (litres)</span>
                        <input name="fuel_litres" type="number" min="0" step="0.01" class="vehicle-form-control">
                    </label>

                    <label class="block">
                        <span class="mb-2 block text-sm font-semibold text-fleet-ink">Fuel Cost (UGX)</span>
                        <input name="fuel_cost" type="number" min="0" class="vehicle-form-control">
                    </label>
                </div>

                <label class="mt-4 block">
                    <span class="mb-2 block text-sm font-semibold text-fleet-ink">Remarks</span>
                    <input name="remarks" type="text" class="vehicle-form-control" placeholder="Any notes">
                </label>
