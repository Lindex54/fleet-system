...
$pdo = fleetDb();
$stmt = $pdo->query("SELECT d.id AS driver_id, d.user_id, d.full_name, d.email, u.name FROM drivers d INNER JOIN users u ON u.id = d.user_id WHERE d.full_name = 'Simon MALINDE' LIMIT 1");
